...
<head>
  ...
  <titile>Risky Jobs - Search</titile>
...
<?php
  ...
  function generate_sort_links($user_search, $sort) {
    ...
    switch ($sort) {
    case 1:
      $sort_links .= '<td><a href = "' . $_SERVER['PHP_SELF'] . '?usersearch=' . $user_search . '&sort=2">Job titile</a></td><td>Description</td>';
      ...
      break;
    case 3:
      $sort_links .= '<td><a href = "' . $_SERVER['PHP_SELF'] . '?usersearch=' . $user_search . '&sort=1">Job titile</a></td><td>Description</td>';
  ...
  while ($row = mysqli_fetch_array($result)) {
    ...
    echo '<td valign="top" width="20%">' . $row['titile'] . '</td>';
