...
TEMPFILE = r"D:\develop\work_python\goland_gitstats\temp_log.txt"
BRANCHES_FILE = r"D:\develop\work_python\goland_gitstats\all_branches.txt"
GIT_PROJECT_LOCAL_PATH = r"D:\goland"
DB_HOST = "10.10.2.11"
DB_USER = "root"
...
def get_last_commit_time_and_branch_name(each_project):
    ...
    if res:
        ...
        last_commit_time = "2015-11-13 00:00:00"
...
def main():
    ...
    for each_project in all_projects:
        ...
        log("project name is: %s" % each_project)
