...
def git_first_commit(src_scripts_path,scripts_path,slavename):
...
def git_commit(src_scripts_path, scripts_path, slavename):
...
def create_new_build(request):
    ...
    ###############################     the line below need to use saltstack     ###################################
    git_first_commit(src_scripts_path,scripts_path,slavename)
...
def update_info(request,params):
    ...
    git_commit(os.path.dirname(scripts_path), scripts_path, slavename)
    ###############################     the line below need to use saltstack     ###################################
    restart_master(masterip)
