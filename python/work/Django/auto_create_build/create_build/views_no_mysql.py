...
def create_new_build(request):
    ...
    if not (slavename and slaveip and slave_platform and buildername and script_contents1 and work_dir1 and description1 and script_contents2 and work_dir2 and description2 and script_contents3 and work_dir3 and description3):
