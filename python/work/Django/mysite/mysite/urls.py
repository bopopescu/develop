...
urlpatterns = patterns('mysite.blog.views',
   #(r'^site_media/(?P<path>.*)$','django.views.static.serve',{'document_root': settings.STATIC_PATH}),
    #url(r'css/(?P<path>.*)$', 'django.views.static.serve', {'document_root':'d:/develop/work_python/mysite/mysite/templates/static/css'}),
    #url(r'js/(?P<path>.*)$', 'django.views.static.serve', {'document_root':'d:/develop/work_python/mysite/mysite/templates/static/js'}),
    #url(r'img/(?P<path>.*)$', 'django.views.static.serve', {'document_root':'d:/develop/work_python/mysite/mysite/templates/static/img'}),
    url(r'^$','index'),
    url(r'^index/$','index'),
