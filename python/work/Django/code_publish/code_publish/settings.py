#-*- encoding:utf-8 -*-
# Django settings for code_publish project.
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': 'code_publish',                      # Or path to database file if using sqlite3.
...
STATIC_ROOT = os.path.join(BASE_DIR, 'publish/templates')
...
SECRET_KEY = '7*m-aafqd5-ll%iqxciq-39kvkm69ea3=j7=s7auh42+tl-7*@'
...
MIDDLEWARE_CLASSES = (
    ...
    'publish.middleware.defend_attack.DefendAttackMiddleWare',
    'publish.middleware.admin_see_error.AdminSeeErrorMiddleWare',
    # Uncomment the next line for simple clickjacking protection:
    # 'django.middleware.clickjacking.XFrameOptionsMiddleware',
)

ROOT_URLCONF = 'code_publish.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'code_publish.wsgi.application'

TEMPLATE_DIRS = (
    # Put strings here, like "/home/html/django_templates" or "C:/www/django/templates".
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    os.path.join(BASE_DIR, "publish/templates/html").replace("\\", "/"),
...
#AUTH_LDAP_BIND_PASSWORD = "ww07758521"
