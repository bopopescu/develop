...
from settings import SPECIAL_CHARS_LIST
        ...
        try:
            ...
            for record in json.loads(download_url_content):
                ...
                if extend_name and extend_name in extend_name_list: 
                    ...
                    #print 11111111111, record["movurl"], record["subtitle"]
                    #movie_filename = ""
        ...
        while 1:
            ...
            while self.urlmanager.has_url():
                ...
                for new_download_url in new_download_url_set:
                    ...
                    #download_html_doc = self.urldownloader.url_download(new_download_url)
                    #download_soup = self.htmlparser.parser(download_html_doc)
                    #self.htmlparser.get_movie_time(download_soup)
