...
#project
from settings import DB_HOST, DB_NAME, DB_USER, DB_PASSWD,LOG_FILENAME, SPECIAL_CHARS_LIST
...
library_list = ["0","a","b","c","d","e","f","g","h","i","j","k","l","m","n","o","p","q","r","s","t","u","v","w","x","y","z"][6:9]
...
class HtmlParser(object):   
    ...
    def get_adress(self, adress_dict, key):
        try:
            ...
            #print "could not get address: %s" % str(e)
            adress = ""
        return adress
        ...
        for each_library in library_list:
            ...
            for each_movie_url in movie_link_urls:
                ...
                (self.mysql.has_record("movie_trailer_movie_name", "id", None, "name", movie_info["movie_name"])):
                    ...
                    #if self.mysql.has_record("movie_trailer_movie_info", "movie_name_id", movie_name_id):
                    #    print "movie_name is already in database or movie_name is None"
                    #    continue
                else:
                ...
                for each_record in movie_info["movie_other_info"]:
                    #print "each_record, %s" % each_record
